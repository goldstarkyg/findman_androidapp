...
public class LocDetailActivity extends BaseActivity
        implements SwipeRefreshLayout.OnRefreshListener, ViewPagerEx.OnPageChangeListener, BaseSliderView.OnSliderClickListener{
    ...
    ArrayList<String> mContent = new ArrayList<>(); // photo array
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.loc_detail_activity_layout);


        MYActivityManager.getInstance().pushActivity(LocDetailActivity.this);
        findViews();
        layoutControls();
        initEvents();
    }
    ...
    protected void findViews(){
        ...
        mAdapter = new DetailPhotoAdapter(LocDetailActivity.this, mContent,2);
        mRecyclerViewImage.setAdapter(mAdapter);

        mCommentAdapter = new CommentAdapter(LocDetailActivity.this, mCommentContent);
...
//                }
    ...
    protected void initData(){
        ...
        try{
            ...
            if(!bProgress){
                mProgressDialog = new ProgressDialog(LocDetailActivity.this, R.style.MyTheme);
    ...
    protected void sliderInit(){
        ...
        for (int x=0; x< mContent.size(); x++) {
            ...
            textSliderView.description("").image(ServerTask.SERVER_IMAGE  + mContent.get(x)).setScaleType(BaseSliderView.ScaleType.Fit).setOnSliderClickListener(LocDetailActivity.this);
...
//            textSliderView.getBundle().putString("extra", name);
        ...
        mDemoSlider.addOnPageChangeListener(LocDetailActivity.this);
    ...
    protected void initView(){
        ...
        imageLoader.init(ImageLoaderConfiguration.createDefault(LocDetailActivity.this));
...
//            mColor2.setBackground(getResources().getDrawable(R.drawable.clor_white));
    ...
    protected void gotoProfile(){
        ...
        if(loginType.equals("user")){
            MYActivityManager.changeActivity(LocDetailActivity.this, ProfileActivity.class, bundle, false, null);
        }else if(loginType.equals("client")){
            MYActivityManager.changeActivity(LocDetailActivity.this, PostActivity.class, bundle, false, null);
        }
    ...
    public void like(){
        ...
        if(userType.equals("client")){
            Toast.makeText(LocDetailActivity.this,"Login as User", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public void comment(){
        ...
        MYActivityManager.changeActivity(LocDetailActivity.this, CommentActivity.class, bundle, false, null);
        overridePendingTransition(R.anim.anim_slide_in_right, R.anim.anim_slide_out_left);
    }
}