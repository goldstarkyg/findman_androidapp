 ...
 */
public class LocalSearchRecyclerAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LocalSearchRecyclerAdapter1(Context context, ArrayList<Card> contactItemArrayList1, RecyclerView recyclerView) {
...
//            normalViewHolder.description.setText(contactItemArrayList.get(i).business_short_description);
            ...
            normalViewHolder.imgFrist.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ((LocalSearchActivity)context).onClickImage(i);
                }
            });
            ...
            normalViewHolder.mLike.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((LocalSearchActivity)context).like(i);
            ...
            normalViewHolder.mDisLike.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((LocalSearchActivity)context).dislike(i);
                }
            });
            normalViewHolder.mCommented.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((LocalSearchActivity)context).comment(i);
                }
            });
