 ...
 */
public class LocSearchRecyclerAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LocSearchRecyclerAdapter1(Context context, ArrayList<Card> contactItemArrayList1, RecyclerView recyclerView) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.loc_info_item, viewGroup, false);
            return new LocSearchRecyclerAdapter1.NormalViewHolder(view);
        } else if (viewType == VIEW_TYPE_LOADING) {
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_loading, viewGroup, false);
            return new LocSearchRecyclerAdapter1.LoadingViewHolder(view);
        }
        return null;
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        if (viewHolder instanceof NormalViewHolder){
            ...
            String path = ServerTask.SERVER_IMAGE + contactItemArrayList.get(i).logo;
            imageLoader.displayImage(path, normalViewHolder.imgTrade, options);
            ...
            normalViewHolder.imgTrade.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ((LocSearchActivity)context).onClickImage(i);
                }
            });
            ...
            normalViewHolder.imgTw.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((LocSearchActivity)context).onClickTW(link);
                }
            });
            ...
            normalViewHolder.imgGp.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((LocSearchActivity)context).onClickGP(link);
                }
            });
            ...
            normalViewHolder.imgFb.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((LocSearchActivity)context).onClickFB(link);
                }
            });
            ...
            normalViewHolder.imgMap.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((LocSearchActivity)context).onClickMap(i);
                }
            });
            ...
            normalViewHolder.mLike.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((LocSearchActivity)context).like(i);
    ...
    private class NormalViewHolder extends RecyclerView.ViewHolder {
        ...
        public NormalViewHolder(View view) {
            ...
            openTimeSunTitle = (TextView)view.findViewById(R.id.openTimeSunTitle);
