 ...
 */
public class ProfileRecyclerAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ProfileRecyclerAdapter1(Context context, ArrayList<Card> contactItemArrayList1, RecyclerView recyclerView) {
        ...
        if(viewHolder instanceof NormalViewHolder){
            ...
            normalViewHolder.imgFrist.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ((ProfileActivity)context).onClickImage(i);
                }
            });
            ...
            normalViewHolder.mLike.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((ProfileActivity)context).like(i);
